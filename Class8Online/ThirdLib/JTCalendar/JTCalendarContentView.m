...
#warning 添加上下滑动手势
    UISwipeGestureRecognizer *swipeGuesture_up = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(upGuesture)];
    swipeGuesture_up.direction = UISwipeGestureRecognizerDirectionUp;
    [self addGestureRecognizer:swipeGuesture_up];
    
    UISwipeGestureRecognizer *swipeGuesture_down = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(downGuesture)];
    swipeGuesture_down.direction = UISwipeGestureRecognizerDirectionDown;
    [self addGestureRecognizer:swipeGuesture_down];
...
- (void)upGuesture{
    ...
    if ([self.calendarManager.dataSource respondsToSelector:@selector(calendarUpAndDownAction:)]) {
        [self.calendarManager.dataSource calendarUpAndDownAction:YES];
    }
}
//下滑手势
- (void)downGuesture{
    ...
    if ([self.calendarManager.dataSource respondsToSelector:@selector(calendarUpAndDownAction:)]) {
        [self.calendarManager.dataSource calendarUpAndDownAction:NO];
    }
}
