...
- (void)configureConstraintsForSubviews
{
    ...
    CGFloat height = (self.frame.size.height - self.calendarManager.calendarAppearance.menuMonthViewHeight)/ weeksToDisplay;
    ...
    for(int i = 0; i < self.subviews.count; ++i){
        ...
        if ([view isKindOfClass:[JTCalendarMonthWeekDaysView class]]) {
            ...
            view.frame = CGRectMake(0, y, width, self.calendarManager.calendarAppearance.menuMonthViewHeight);
