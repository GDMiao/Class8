...
@optional
- (void)didChangeValueCameraSlider:(CameraSlider *)slider value:(CGFloat)value;
- (void)didCameraSliderTouchEnd:(CameraSlider *)slider value:(CGFloat)value isTouch:(BOOL)isTouchEnd;
