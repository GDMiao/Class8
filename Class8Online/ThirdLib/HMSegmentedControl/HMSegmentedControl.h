...
/**
 * 拓展 图片icon 与文字 间隙 默认 5.0
 **/
@property (nonatomic) float clearanceIconWitTitle;

/**
 * 拓展
 * 文字颜色 默认 黑色
 **/
@property (nonatomic) UIColor *textColor,*selectedTextColor;
/**
 * 拓展
 * 文字字体
 **/
...
@property (nonatomic,strong) NSMutableArray *badgeIndexArray;
