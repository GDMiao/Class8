...
-(void)startRecord
{
    ...
    NSString *savePath = [FILECACHEMANAGER getFileRootPathWithFileType:FileType_Audio];
    self.filename = [self createFilename];
    NSString *soundFilePath = [savePath stringByAppendingPathComponent:self.filename];
