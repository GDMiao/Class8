...
@property (assign, nonatomic) CGFloat menuMonthViewHeight;
...
@property (strong, nonatomic) UIColor *dayTextColorWeekDay; /*拓展 周末天的颜色*/
...
@property (assign, nonatomic) BOOL firstLoad; //是否首次加载 初始化为 yes 时代表当月当日 显示红色底 为No 没有底色 文字颜色为初始底色
