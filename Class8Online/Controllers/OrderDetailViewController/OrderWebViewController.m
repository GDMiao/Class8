...
//  Class8Online
//
//  Created by miaoguodong on 16/5/30.
//  Copyright © 2016年 chuliangliang. All rights reserved.
//

#import "OrderWebViewController.h"
#import <AlipaySDK/AlipaySDK.h>
@interface OrderWebViewController ()<UIWebViewDelegate>
...
- (void)payWithUrlOrder:(NSString*)urlOrder
{
    if (urlOrder.length > 0) {
        ...
        [[AlipaySDK defaultService]payUrlOrder:urlOrder fromScheme:@"Class8Online" callback:^(NSDictionary* result) {
            // 处理支付结果
            NSLog(@"%@", result);
