...
+ (instancetype)plusButton {
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"post_normal@2x.png"];
    [button setImage:buttonImage forState:UIControlStateNormal];
    [button setTitle:@"创课" forState:UIControlStateNormal];
...
- (void)clickPublish {
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"创课"
                                                             delegate:self
