...
{
//    UINavigationController *navigationController = [(KL_AppDelegate *)[[UIApplication sharedApplication] delegate] navViewController];
//    [navigationController popToRootViewControllerAnimated:NO];
//    
//    KL_LoginViewController *vc = [[KL_LoginViewController alloc] init];
...
//        KL_JSONModule *response = [[KL_JSONModule alloc] initWithJSON:[self responseJSON]];
//        if (response.code_ == 501 && [[KL_Account shareInstance] isLoginSuccess]) {
//            delegate = nil;
//            [[KL_Account shareInstance] removeAccount];
////            [[KL_Account shareInstance] setUserExpire:YES];
//            
//            [self performSelector:@selector(popToLoginViewController) withObject:nil afterDelay:0.5];
//            [response release];
//            return;
//        }
//        [response release];
...
+ (void)registerForNetworkReachabilityNotifications
{
	[[NewReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[NewReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);
}
